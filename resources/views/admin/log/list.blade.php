        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <form action="{{ url('log/list') }}" method="get">
                                <div class="col-lg-2">
                                    <input name="userName" value="{{ Input::get('userName','') }}" class="form-control" placeholder="用户名" />
                                </div>
                                <div class="col-lg-2">
                                    <input name="url" value="{{ Input::get('url','') }}" class="form-control" placeholder="URL" />
                                </div>
                                ...
                                if(true == isset($pager)) {
                                    foreach ($pager as $item) {
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $item->url }}</td>
                                            <td title="{{ $item->controller . "@" . $item->class_method }}">{{ $item->class_name . "@" . $item->class_method }}</td>
                                            <td>{{ $item->real_method . "【" . $item->method . "】"}}</td>
                                            <td title="{{ $item->parameter }}">{{ $item->description }}</td>
